...
export default function Contact() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 mb-8">
      <section
        id="contact"
        className="bg-gray-900 py-10 sm:py-12 text-white border border-orange-500/20 rounded-3xl scroll-mt-16"
      >
        <div className="px-8">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-white font-medium break-all">eranda@shaw.ca</p>
                  </div>
                </a>
